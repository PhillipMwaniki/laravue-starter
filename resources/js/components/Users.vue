            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <button class="btn btn-success" data-toggle="modal" data-target="#addNew"><i class="fas fa-user-plus"></i> User</button>
                    </div>
                </div>
                <!-- /.card-header -->
            ...
            <div class="modal-content">
                ...
                <form @submit.prevent="createuser">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <select v-model="form.type" type="type" name="type" placeholder="User Type" class="form-control" :class="{ 'is-invalid': form.errors.has('type') }">
